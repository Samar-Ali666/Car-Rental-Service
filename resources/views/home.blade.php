...
<header class="header header-relative header-fixed-on-mobile navbar-dark">
    ...
    <div class="column width-12 nav-bar-inner">
        ...
        <nav class="navigation nav-block primary-navigation nav-right sub-menu-indicator">
            <ul>
                <li class="current">
                    <a href="{{ route('home') }}">Current Rides</a>
                </li>
                <li class="">
                        ...
                        <div class="title-container-inner">
                            <div class="row flex">
                                <div class="column width-6 v-align-middle">
                                    <div>
                                        <h1 class="mb-0">Current Orders</h1>
                                        <p class="lead mb-mobile-20">My All Current Bookings.</p>
        ...
        <div class="row">
            <div class="column width-10 offset-1">
                <div class="with-background">
                    ...
                    <div class="row">
                        <div class="column width-12">
                            <p class="lead">You currently have <span class="item-number weight-bold">{{$order_count}}</span> cars in your order list.</p>
                        </div>
                        <div class="column width-12">
                            <hr>
                        </div>
